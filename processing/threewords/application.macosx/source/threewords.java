import processing.core.*; import processing.opengl.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; import javax.sound.midi.*; import javax.sound.midi.spi.*; import javax.sound.sampled.*; import javax.sound.sampled.spi.*; import java.util.regex.*; import javax.xml.parsers.*; import javax.xml.transform.*; import javax.xml.transform.dom.*; import javax.xml.transform.sax.*; import javax.xml.transform.stream.*; import org.xml.sax.*; import org.xml.sax.ext.*; import org.xml.sax.helpers.*; public class threewords extends PApplet { 
...
class Word {
  ...
  public Word(String w, int x, int y, int r, int g, int b) {
    ...
    this.b = b;
    this.a = ALPHA_START;
    this.palette = PApplet.parseInt(random(3));
    this.drift = PApplet.parseInt(random(4));
  }
...
public void draw() {
  ...
  int nextWord = PApplet.parseInt(textWidth((String)words.get(index + 1) + " "));
  int thisWord = PApplet.parseInt(textWidth(s + " "));
  ...
  if ( (x + nextWord) >= WIDTH) {
    ...
    y = y + PApplet.parseInt(textAscent() + textDescent());
    x = MARGIN;    
  ...
  static public void main(String args[]) {     PApplet.main(new String[] { "threewords" });  }}